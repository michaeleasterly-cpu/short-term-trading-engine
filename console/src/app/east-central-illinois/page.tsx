                ...
                {[
                  {
                    ...
                    step: "Browser-grade retry 2026-05-28. The ETA-9172 PIRL schema (DOL-only Participant Individual Record Layout, PY24+) defines a \"Primary ETA Assigned Local Workforce Board Code\" field — the data architecture confirms a separate numeric code exists in DOL ETA's WIPS reporting infrastructure. The public-facing LWIA Assigned Code and Name Report at etareports.doleta.gov/cfdocs/grantee_prod/reporting/template/LWIA_Reports.cfm IS the canonical public source — but that endpoint returns ECONNREFUSED from this environment (CFM endpoint; not a WAF block; appears genuinely unreachable for non-IL-state-DOL networks). DOL Local Workforce Board Code Management Tool Guide PDF (dol.gov/sites/dolgov/files/ETA/Performance/pdfs/wips/) returns 403 to programmatic access. Other public-source attempts (IL workNet LWIA Matrix, IPATS, CEFS Form 990, WIOA State Plan Portal, lwa23.com) confirm the public identifier is the literal \"LWIA 23\" designation. Page uses the canonical LWIA 23 identifier; a separate numeric ETA code exists in the federal WIPS schema but is not surfaceable in this environment.",
                  },
                  {
