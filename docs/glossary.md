...
macro_indicators: `platform.macro_indicators` table — five canonical FRED series (sahm_rule, industrial_production, initial_claims, yield_curve, hy_spread). One row per (indicator, observation_date). Built 2026-05-14 as the last data source from MASTER_PLAN §6.1. Unblocks the Sentinel macro-defense engine.
