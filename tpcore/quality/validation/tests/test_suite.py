...
async def test_run_suite_writes_one_score_per_check() -> None:
    ...
    assert len(writer.scores) == 27  # +insider_filings_freshness (2026-05-22)
    ...
    assert sources == {
        ...
        "validation.insider_filings_freshness",
    }
...
async def test_run_suite_aggregates_failures() -> None:
    ...
    # All 27 rows still written (+insider_filings_freshness 2026-05-22)
    assert len(writer.scores) == 27
