...
_TRAINING_LADDER_ROSTER = [
    ...
    {"id": "il_doc_officer", "name": "IL DOC correctional officer (Pinckneyville / Big Muddy / Vienna / Shawnee)", "supersector_code": "9091",
     ...
     "notes": "IL DOC carries a structural staffing crisis: approximately 25% overall vacancy as of January 2022, ~28-29% corrections-officer vacancy as of recent reporting. The system is hiring statewide post-COVID; the corrections-officer ladder is one of the few reliably-open family-supporting state jobs in the region. Attrition is mandatory-OT-driven, not academy-washout. Verbatim Indeed reviews: '40-hour shift PLUS at least two shifts of Mandatory overtime every week — does not make up for lost time with family'; 'Inmates have more rights and treated better than staff'; 'Toxic command staff'. Pension + benefits keep people; OT family-time loss is the dominant exit driver. Physical fitness test (push-ups + sit-ups + 1.5-mile run + body composition) is a real wash-out. Family-supporting wage + state pension + benefits make this attractive once hired; mandatory OT is the structural lifestyle cost the wage column doesn't reflect. Sources: indeed.com IDOC pay-and-benefits reviews; Center Square Oct 2024 + WTTW Oct 2024 understaffing analysis."},
